            ...
            actions: [
              MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    int? userto_id=0;
                    if(value.mainUserId==value.jobListOnProfile[index].giverId){
                      userto_id=value.jobListOnProfile[index].accepterId;
                    }
                    else if (value.mainUserId==value.jobListOnProfile[index].accepterId){
                    ...
                    await value.PostComment(commentController.text,value.mainUserId,userto_id,value.jobListOnProfile[index].id);
